...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Kami dengan senang hati memberitahukan bahwa hasil pemeriksaan laboratorium Anda telah selesai dan siap
                untuk diunduh.</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span
                        class="info-value">{{ $examination->scheduled_date ? \Carbon\Carbon::parse($examination->scheduled_date)->format('d F Y') : 'Belum dijadwalkan' }}</span>
                </div>
                <div class="info-row">
            ...
            <div class="highlight">
                ...
                @endphp
                    <a href="{{ $resultFile->getUrl() }}" target="_blank" class="btn">Download Result</a>
            </div>
            ...
            <p>Terima kasih telah mempercayakan pemeriksaan laboratorium Anda kepada kami. Jika ada pertanyaan atau
                memerlukan bantuan, jangan ragu untuk menghubungi kami.</p>
        </div>
