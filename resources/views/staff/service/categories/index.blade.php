{{-- resources/views/staff/service/categories/index.blade.php --}}
<x-staff-layout>
    <x-slot name="header">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Daftar Kategori Layanan</h3>
                        <a href="{{ route('staff.service.categories.create') }}" 
                    ...
                    <form method="GET" action="{{ route('staff.service.categories.index') }}" class="mb-6">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($categories as $category)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $category->service_items_count }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                            <a href="{{ route('staff.service.categories.show', $category) }}" 
                                            ...
                                            <form method="POST" action="{{ route('staff.service.categories.destroy', $category) }}" 
                                                  class="inline" 
