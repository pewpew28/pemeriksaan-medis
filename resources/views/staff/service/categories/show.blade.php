{{-- resources/views/staff/service/categories/show.blade.php --}}
<x-staff-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Detail Kategori Layanan') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <a href="{{ route('staff.service.categories.edit', $category) }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-lg text-gray-900">{{ $category->code ?? '-' }}</p>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $statistics['totalServiceItems'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-gray-600">Layanan Aktif</p>
                                <p class="text-2xl font-bold text-gray-900">{{ $statistics['activeServiceItems'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($statistics['totalRevenue'], 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between mb-6">
                        <h4 class="text-lg font-medium text-gray-900">Daftar Layanan</h4>
                        <a href="{{ route('staff.service.create') }}?category={{ $category->id }}" 
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($category->serviceItems->sortBy('sort_order') as $serviceItem)
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{ $serviceItem->name }}</div>
                                                @if($serviceItem->description)
                                                    <div class="text-sm text-gray-500 max-w-xs truncate">{{ $serviceItem->description }}</div>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-500">{{ $serviceItem->code ?? '-' }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">Rp {{ number_format($serviceItem->price, 0, ',', '.') }}</div>
                                                @if($serviceItem->unit)
                                                    <div class="text-sm text-gray-500">per {{ $serviceItem->unit }}</div>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan layanan pertama untuk kategori ini.</p>
                            <div class="mt-6">
                                <a href="{{ route('staff.service.create') }}?category={{ $category->id }}" 
                                   class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
